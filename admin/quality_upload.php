...
// Verify and/or create the qualityy
if (!is_dir($targetDir)) {
...
if(isset($_POST['users'])) {
    ...
    if ($fileType == 'application/pdf') {
        if (move_uploaded_file($_FILES["file"]["tmp_name"], $targetFile)) {
            ...
            $sql = "INSERT INTO quality (title, filename, folder_path, time_stamp, uploaded_by,uploader, department,category, status, selected_users) VALUES ('$title','$filename', '$folder_path','$time_stamp','$user','$uploader','$department','$category','approved', '$selected_users_str')";
