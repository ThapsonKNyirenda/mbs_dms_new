...
<div id="loading"></div>
  ...
  <main id="main" class="main" style="margin-bottom: 50px;">
    ...
    <div class="pagetitle">
      <h1 class="mb-3">FINANCE AND ADMINISTRATION DEPARTMENT</h1>
      <hr>
      <nav>
        <ol class="breadcrumb">
          <li class="breadcrumb-item"><a href="dashboard.php">Home</a></li>
          <li class="breadcrumb-item">Department/</li>
          <li class="breadcrumb-item active">Finance and Administration Department</li>
        ...
        <div class="col-lg-8" style="width: 100%;">
          <div class="row">
            ...
            <div class="col-xxl-4 col-md-12">
              ...
              <form id="myForm" action="finance_upload.php" enctype="multipart/form-data" method="POST" onsubmit="return validateForm();">
                    <div class="row mb-3">
                        ...
                        <?php
                            ...
                            if ($result->num_rows > 0) {
                                ...
                                while($row = $result->fetch_assoc()) {
                                  $filePath = '../uploads/finance/' . $row['filename'];
                                ...
                                // }
                                  echo'
                                      ...
                                      <td>'.$row["uploader"].'</td>
                                      <td>
                                          <span><a href="../uploads/finance/'.$row['filename'].'"><button class="btn btn-danger" id="btn2"><i <i class="bi bi-eye"></i></i> View</button></a></span>
                                          <span><a href="finance_edit_file.php?file_id='.$row['id'].'"><button class="btn btn-danger" id="btn2"><i class="bi bi-pencil-square"></i> Edit</button></a></span>
