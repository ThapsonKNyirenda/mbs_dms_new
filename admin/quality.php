...
<div id="loading"></div>
  ...
  <main id="main" class="main" style="margin-bottom: 50px;">
    ...
    <div class="pagetitle">
      <h1 class="mb-3">QUALITY ASSURANCE SERVICE DEPARTMENT</h1>
      <hr>
      <nav>
        <ol class="breadcrumb">
          <li class="breadcrumb-item"><a href="dashboard.php">Home</a></li>
          <li class="breadcrumb-item">Department/</li>
          <li class="breadcrumb-item active">Quality Control Department</li>
          ...
          <div class="row">
            ...
            <div class="col-xxl-4 col-md-12">
              <div class="card info-card sales-card p-3">
                <form action="quality_upload.php" enctype="multipart/form-data" method="POST">
                <div class="row mb-3">
                    ...
                    <div class="row mb-3">
                      ...
                      <div class="col-sm-6">
                      <?php
                        $sql = "SELECT * FROM users WHERE department = 'quality' AND role = 'user'";
                        ...
                        <?php
                            ...
                            if ($result->num_rows > 0) {
                                ...
                                while($row = $result->fetch_assoc()) {
                                  $filePath = '../uploads/quality/' . $row['filename'];
                                  ...
                                  echo'
                                      ...
                                      <td>'.$row["uploader"].'</td>
                                      <td>
                                          <span><a href="../uploads/quality/'.$row['filename'].'"><button class="btn btn-danger" id="btn2"><i <i class="bi bi-eye"></i></i> View</button></a></span>
                                          <span><a href="quality_edit_file.php?file_id='.$row['id'].'"><button class="btn btn-danger" id="btn2"><i class="bi bi-pencil-square"></i> Edit</button></a></span>
    ...
    $(document).ready(function() {
        ...
        $('.delete-button').click(function(event) {
          ...
          Swal.fire({
            ...
            if (result.value) {
                window.location.href = "delete_quality.php?doc_id=" + docId;
            }
        });
