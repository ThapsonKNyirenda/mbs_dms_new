                ...
                <div class="card info-card sales-card" style="width: 100%; ">
                  ...
                  <div class="card-body" style="width: 100%;">
                    ...
                    <div class="d-block align-items-center p-2" style="width:100%; overflow-x: auto;">
                      <div>
                        <p><input type="text" class="input-from" placeholder="From..."> </p>
                        <P><input type="text" class="input-to" placeholder="To..."> <hr color="black"></P>
                        
                      </div>
                      <div>
                        <p> Subject :<input type="text" class="input-subject" placeholder="Subject..."></p>
                      </div>
